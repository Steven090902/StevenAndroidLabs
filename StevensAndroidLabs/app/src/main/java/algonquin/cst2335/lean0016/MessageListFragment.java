...
public class MessageListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        EditText typedMessage = chatLayout.findViewById(R.id.editMessage);
        send = chatLayout.findViewById(R.id.sendbutton);
        Button rec = chatLayout.findViewById(R.id.receiveButton);
    ...
    public void notifyMessageDeleted(ChatMessage chosenMessage, int chosenPosition) {
        ...
        builder.setMessage("Are you sure want to delete the message: " + chosenMessage.getMessage())
                .setTitle("Danger!")
    ...
    class MyChatAdapter extends RecyclerView.Adapter {
        @Override
